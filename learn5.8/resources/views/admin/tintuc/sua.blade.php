    ...
    <div class="container">
        ...
        <form action="admin/tintuc/sua/{{$tintuc->id}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input value="{{$tintuc->TieuDe}}" id="TieuDe" name="TieuDe" placeholder="Nhập tiêu đề" type="text"
                           class="form-control">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <textarea name="TomTat" id="TomTat" cols="40" rows="5"
                              class="form-control">{{$tintuc->TomTat}}</textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="NoiDung" class="col-4 col-form-label">Nội dung</label>
                <div class="col-8">
                    <textarea name="NoiDung" id="NoiDung" cols="30" class="ckeditor"
                ...
                <div class="col-8">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input
                            ...
                            {{"checked"}}
                            @endif
                            name="NoiBat" id="NoiBat_0" type="radio" class="custom-control-input" value="1">
                        <label for="NoiBat_0" class="custom-control-label">Có</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input  name="NoiBat" id="NoiBat_1" type="radio"
                                @if($tintuc->NoiBat == 0)
                                {{"checked"}}
                                @endif
